...
public class EducationApp extends App {
    ...
    public EducationApp(Developer developer, String appName, double appSize, double appVersion, int ageRating, boolean inAppPurchase, String language, String license, double appCost, String subjectCategory, int level) {
