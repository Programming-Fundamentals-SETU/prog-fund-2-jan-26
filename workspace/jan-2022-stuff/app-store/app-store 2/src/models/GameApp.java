...
public class GameApp extends App {
    ...
    public GameApp(Developer developer, String appName, double appSize, double appVersion, int ageRating, boolean inAppPurchase, String language, String license, double appCost, String gameGenre, boolean multiplayer) {
