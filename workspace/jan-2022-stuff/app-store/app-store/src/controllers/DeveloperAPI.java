...
public class DeveloperAPI implements ISerializer {
    ...
    public void load() throws Exception {
        ...
        ObjectInputStream in = xstream.createObjectInputStream(new FileReader("developers.xml"));
    ...
    public void save() throws Exception {
        XStream xstream = new XStream(new DomDriver());
        ObjectOutputStream out = xstream.createObjectOutputStream(new FileWriter("developers.xml"));
