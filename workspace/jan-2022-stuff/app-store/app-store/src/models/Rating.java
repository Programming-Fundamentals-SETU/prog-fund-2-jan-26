...
public class Rating {
    ...
    private int numberOfStars = 0;  //between 1 and 5 inclusive; default 0
    private String raterName = "<rater name>";   //name of rater - max 20 chars; default <rater name>  //todo
    private String ratingComment = "<no comment>";  //comment (optional); default <no comment>   //todo
