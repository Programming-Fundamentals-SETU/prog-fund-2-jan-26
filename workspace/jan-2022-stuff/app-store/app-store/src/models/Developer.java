...
public class Developer {
    ...
    private String developerName = "<no developer>"; //developer name - max 30 chars  //todo
    private String developerWebsite = "<no website>"; //website name - validate format   //todo
