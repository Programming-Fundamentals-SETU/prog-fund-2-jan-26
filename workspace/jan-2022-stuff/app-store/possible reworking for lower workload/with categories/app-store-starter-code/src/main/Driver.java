    ...
    private void runMainMenu() {
        ...
        while (option != 0) {
            switch (option) {
                ...
                //case 2 -> // TODO run the App Store Menu and the associated methods (see spec)
                //case 3 -> // TODO run the Reports Menu and the associated methods (see spec)
                case 4 -> searchAppsBySpecificCriteria();
                //case 5 -> // TODO Sort Apps and the associated methods (see spec)
