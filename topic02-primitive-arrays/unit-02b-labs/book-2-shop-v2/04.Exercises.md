...
Now try generate another of these expections on the `store` object - just remove the instantiation and run your code.  See can you follow the red `call stack dump` to locate the source of the error.  
