...
Download the XStream, version 1.4.21 `jar` file from this website:

- <https://mvnrepository.com/artifact/com.thoughtworks.xstream/xstream/1.4.21>

When you get to this page, use the 'jar' link to download the jar file.  

![](img/xml03.png)

You can then drag this file into IntelliJ's **lib** folder.
