...
There is starter code for PetsDayCareAPI in the Starter Code you are given.
...
### updateParrot(int id, Cat updatedDetails) 
This method takes in a id and replaces the corresponding  object with the Parrot object as input (updatedDetails).
...
## Sorting Methods
### sortPetsById()
 - sorts all pets in the arraylist by thier id

### sortPetsByName()
 - sorts all pets in the arraylist by thier name
