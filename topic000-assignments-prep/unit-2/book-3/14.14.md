...
- Chronology of your implementation (what you did first, etc.. ) This should be similar to your commit history. 
...
Specifically you should specify which AI Bots (if any were used) and the specific prompts used for the generation of the tests. 
