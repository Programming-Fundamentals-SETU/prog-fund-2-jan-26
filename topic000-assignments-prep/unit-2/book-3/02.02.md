...
[Starter Code](archives/KennelCare_Starter.zip).
...
| Class Name   | Responsibility                                               |
| :----------- | :----------------------------------------------------------- |
| Driver | The responsibility for this class is to manage the User Interface (UI) i.e. the menu and user input/output.  This class should be the only class that has System.out.println() or Scanner reads in it.  This class contains an object of DayCare.|
| DayCare | The responsibility for this class is to store and manage a list of Pets.  Note that Pets is the super class in the hierarchy pictured below, so any subclass objects can be added to this list of Pets e.g. an object of Dog can be added to it. |
...
| :---------- | :------------ | :-------------------- | :----------------------------------- |
| Pet | Super Class |  Abstract | Manages the  information relating to a Pet i.e. mass and diameter |
| Dog  | Sub Class of Pet |  Concrete | Manages the specific information relating to an Dog i.e. breed  |
| Cat  |Sub Class of Pet | Concrete | Manages the specific information relating to a Cat e.g. favourite toy |
