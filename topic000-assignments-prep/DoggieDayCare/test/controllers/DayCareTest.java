...
class DayCareTest {
    ...
    class CRUD { // TODO  add in tests for add, read, update
        ...
        @Test
        void removeDogValidIndex() {
            dayCare.addDog(dog1);
            assertEquals(dog1, dayCare.removeDog(0));
            assertTrue(dayCare.getDogsArray().isEmpty());
            dayCare.addDog(dog1);
            dayCare.addDog(dog2);
            dayCare.addDog(dog3);
        ...
        @Test
        void updateDogValidIndex() {
            dayCare.addDog(dog1);
            dayCare.updateDog(0, dog2);
            assertEquals(dog2, dayCare.getDogsArray().get(0));
            Dog dg = new Dog(1234, "dog1234", "Br1234", true, 10, 'm',  true, owner1 );
            dayCare.addDog(new Dog(1234, "dog1234", "Br1234", true, 10, 'm',  true, owner1 ));
            assertEquals(new Dog(1234, "dog1234", "Br1234", true, 10, 'm',  true, owner1 ),
                    dayCare.updateDog(1,dg));
        }
        @Test
