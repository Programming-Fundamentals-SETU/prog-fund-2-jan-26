...
class PetsDayCareAPITest {
    ...
    PetsDayCareAPI validAPI, emptyAPI;
    ...
    void setUp() {
        ...
        emptyAPI = new PetsDayCareAPI("NothingHere", 20, file); // >10 chars
        boundaryMaxAPI = new PetsDayCareAPI("Test", 100, file); // upper boundary
        owner_1 = new Owner(100, "Siobhan", "087-999");
        Dog doggie = new Dog("Buddy",12,  owner_1, 12, 'M', true, 23, false, "LABRADOR RETRIEVER", false);
        Cat cattie = new Cat("kitty", 3, owner_1, 22, 'F', true, 5, true, true, "FEATHER WAND");

        validAPI.addPet(doggie);
        validAPI.addPet(cattie);
    }
