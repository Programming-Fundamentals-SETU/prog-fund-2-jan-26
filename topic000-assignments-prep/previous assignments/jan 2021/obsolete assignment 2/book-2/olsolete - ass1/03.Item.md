...
- *itemDescription*: The description is maximum 50 characters.  When creating a new item, if no description is supplied, you should default the text "No Description".  When updating itemDescription, you should only update if the value is less than or equal to 50.  
