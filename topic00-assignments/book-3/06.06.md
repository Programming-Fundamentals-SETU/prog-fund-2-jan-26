...
The responsibility for this *concrete* class is to extend Mammal and implement the class for a Dog.  The UML is here:
...
|------------------------------|------------------------|------------------------|------------------------|
| breed          | Golden Retriever              | (20 chars)                   | can use DogBreedUtility class  *see below
| dangerousBreed          | true             | false             |  true if dog is a dangerous breed|


\* A dog breed must be one of (case insensitive):
   - "Labrador Retriever", 
   - "German Shepherd",
   - "Golden Retriever",
   - "Bulldog",
...
|------------------------------|------------------------|------------------------|------------------------|
| DANGEROUS_DAILY_RATE          | float              | 40                   | daily cost to house if dangerous|
| NONDANGEROUS_DAILY_RATE          | float             | 30             |  daily cost to house if not dangerous|
...
- details from the Mammal toString() as well as fields above.
