...
The responsibility for this *concrete* class is to extend Bird and implement the class for a Parrot.  The UML is here:
...
|------------------------------|------------------------|------------------------|------------------------|
| vocabularySize          | Basic              | Amazing                   | number of words is changed to a String using the **BirdUtility**  class|
