...
## Starting the New Project
 We are giving you starter code. As per the lab on GitHub Classroom, you will need to clone the starter code to your local machine. For details, check the lab [here](https://tutors.dev/lab/prog-fund-2-jan-26/topic09-polymorphism-abstraction/unit-09b-labs/book-2-github).
...
**Remember to continually push to the remote as the regularity of your commits/pushes is important.**
---
...
---
## Interface  that is  given:
| Interface Name   | Responsibility                                               |
| :----------- | :----------------------------------------------------------- |
| iSerializer | An interface that should be implemented by the AppStoreAPI.
...
| PetsDayCareAPI | The responsibility for this class is to store and manage a list of Pets.  Note that Pets is the super class in the hierarchy pictured below, so any subclass objects can be added to this list of Pets e.g. an object of Dog can be added to it. |
