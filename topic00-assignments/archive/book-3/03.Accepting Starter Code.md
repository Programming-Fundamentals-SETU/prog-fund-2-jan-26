...
<https://classroom.github.com/a/OrZlMkmX>


You will be prompted to accept the assignment as before:
...
When you click on the "Generate..." button, you will be brought to your browser, where you can select "90 days" or more as your Expiration date.  You may need to change the name of the token as it needs to be unique. Then scroll down and click the "Generate Token" button.
