...
Looking at the red text in the `call stack dump`, we start at the last line printed on the screen and work our way upwards.  So, we can see the last line printed was:
...
Again looking at our code, we can see that, within the addProduct method, line 33 was the read of the Product Code input from the user:
...
- On line 24 in Driver.java, you called a method `addProduct()`
- Then, on line 33 within this addProduct() method, you called a line of code:  `int productCode = input.nextInt();`
