...
- https://github.com/Prog-Fund/lab-prog-fund-26

You WON'T have access to our URL - this is Mairead's and Siobhan's one.  

Instead, you use your own personal URL to the repo that was just generated.  It will be along this format i.e.:

- https://github.com/Prog-Fund/lab-prog-fund-26-YOUR-GITHUB-ID


Make a note of/bookmark  **your** URL...you will need this in a few moments (and also later in the lab). If you are having trouble finding your URL, just to go your GitHub account and you should find the repo in there.
...
Use a name e.g. pf2-lab-05022026    (last string is date) 
