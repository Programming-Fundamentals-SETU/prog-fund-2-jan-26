...
Using the files from [solution to ShopV5.0](archives/ShopV5.0.zip), create a new project called ShopV6.0.

Run your new ShopV6.0 and verify that you have the following menu displayed:
